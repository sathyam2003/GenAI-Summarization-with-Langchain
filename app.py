...
# The main function is UPDATED for a better UI.
def main():
    st.set_page_config(page_title="Custom PDF Summarizer", page_icon="", layout="wide")
    
    # --- Main Content ---
    st.title(" Custom PDF Summarizer")
    st.markdown("This app allows you to upload a PDF file, provide a custom instruction, and get a tailored summary generated by Google's Gemini model.")
    ...
    if uploaded_file is not None:
        ...
        st.sidebar.info(f"✅ Successfully uploaded `{uploaded_file.name}`")
        ...
        st.info("Upload a PDF and enter your prompt in the sidebar to get started.")
